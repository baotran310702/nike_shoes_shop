  ...
  return (
    <>
        <div className='relative h-28 w-32 rounded-xl overflow-hidden group cursor-pointer transition-all duration-300 lg:w-28 md:w-24 sm:w-16 lg:h-24 md:h-20 sm:h-14'>
            ...
            ></img>
            <div className='bg-white blur-effect-theme absolute top-11 left-11 lg:top-9 lg:left-11 sm:top-7 sm:left-10 right-0 opacity-100 z-[100]
            ...
            <video autoPlay={true}
                ...
                muted={true}
                playsInline={true}
                className='absolute top-0 left-0 right-0 w-full h-full flex object-cover opacity-0 z-0
                group-hover:opacity-100 group-hover:z-20 rounded-xl'
            >
