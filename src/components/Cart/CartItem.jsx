    ...
    <>
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          <div
            className={`bg-gradient-to-b from-blue-900 to-blue-500 hover:scale-105 transition-all duration-300 ease-in-out grid items-center`}
          >
            <img
              src={img}
          ...
          <div className="grid items-center gap-4">
            <div className="grid items-center leading-none">
              ...
              <p className="font-sm text-slate-800 lg:text-xs">{text}</p>
            </div>
            <div className="flex items-center justify-around w-full">
              ...
              <div className="bg-theme-cart rounded font-sm w-7 h-6 lg:w-6 lg:h-5 flex items-center justify-center text-white stroke-[2] ">
                {cartQuantity}
              </div>
              <button
                type="button"
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button
              type="button"
              className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 lg:p-0.5 grid items-center justify-items-center"
              onClick={deleteItems}
            >
